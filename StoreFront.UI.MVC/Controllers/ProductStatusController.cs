...
namespace StoreFront.UI.MVC.Controllers
{
    ...
    public class ProductStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IsInStock,IsBackOrdered,IsDiscontinued,ProductId,ProductStatusId")] ProductStatus productStatus)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Products, "ProductId", "ProductDescription", productStatus.ProductId);
            return View(productStatus);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IsInStock,IsBackOrdered,IsDiscontinued,ProductId,ProductStatusId")] ProductStatus productStatus)
        {
