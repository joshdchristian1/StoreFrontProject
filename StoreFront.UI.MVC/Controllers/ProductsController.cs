...
namespace StoreFront.UI.MVC.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductPrice,ProductDescription,ProductQuantity,ProductOnOrder,CategoryId,ProductImage")] Product product)
        {
